...
static long long strtoll_len(const char *nptr, char **endptr, int base, unsigned long maxlen) {
	...
	if (maxlen == 0) {
		...
		s = xsg_string_truncate(s, 0);
		s = xsg_string_append_len(s, nptr, maxlen);
...
static unsigned long long strtoull_len(const char *nptr, char **endptr, int base, unsigned long maxlen) {
	// TODO: reimplement without string copy
	if (maxlen == 0) {
...
static double strtod_len(const char *nptr, char **endptr, unsigned long maxlen) {
	// TODO: reimplement without string copy
	if (maxlen == 0) {
...
static void scan_s_len(const char *nptr, char **endptr, unsigned long maxlen) {
	unsigned long len = 0;
...
static void scan_c_len(const char *nptr, char **endptr, unsigned long maxlen) {
	unsigned long len = 0;
...
static void scan_set_len(const char *nptr, char **endptr, const char *fmt, char **endfmt, unsigned long maxlen) {
...
static bool scan(const char **buffer, const char **format) {
	const char *b = *buffer;
	const char *f = *format;
...
char *xsg_scanf_string(const char *buffer, const char *format) {
	...
	string = xsg_string_append_len(string, buffer, len);
