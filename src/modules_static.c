...
#define XSG_MODULE(parse, help, info) static const char info_inostat[] = info
#define XSG_MODULE_NAME "inostat"
#include "modules/inostat.c"
#undef XSG_MODULE_NAME
#undef XSG_MODULE
...
#define XSG_MODULE(parse, help, info) static const char info_lstat[] = info
#define XSG_MODULE_NAME "lstat"
#include "modules/lstat.c"
#undef XSG_MODULE_NAME
#undef XSG_MODULE
...
#define XSG_MODULE(parse, help, info) static const char info_stat[] = info
#define XSG_MODULE_NAME "stat"
#include "modules/stat.c"
#undef XSG_MODULE_NAME
#undef XSG_MODULE
